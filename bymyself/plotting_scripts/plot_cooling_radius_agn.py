...
dirname = '/public/home/zju_visitor/LiuYuanhao/SAM_project/bymyself/pics/agn_cooling_radius'
...
for i, snap in enumerate(snaps):
    ...
    plt.savefig(dirname + '/agn_cr_vs_mass_' + what_to_plot + f'snap{snaps[i]}_50-1.pdf',format='pdf')
