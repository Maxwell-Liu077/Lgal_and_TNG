"""Top-level orchestration for the self-contained Phase 1.8 analysis."""
...
from .halo_evaluation import evaluate_halos
from .result_builder import build_phase18_result
from ..io.sample import attach_subfind_membership, load_or_build_sample
from ..io.state_cache import prepare_halo_states
from ..io.tracer_products import prepare_tracer_products
...
def run_phase18(
    ...
    *,
    ...
    """Run the complete self-contained Phase 1.8 pipeline."""
